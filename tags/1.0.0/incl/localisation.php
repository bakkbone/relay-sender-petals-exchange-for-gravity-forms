...
define('PGF_FIELD_DELDATE_TOOLTIP', __('', 'relay-sender-petals-exchange-for-gravity-forms'));
...
Total value of the order in the currency Petals has you registered to send and receive orders in. Format is $$$.cc, eg. 123.00 - must include the cents.', 'relay-sender-petals-exchange-for-gravity-forms'));
