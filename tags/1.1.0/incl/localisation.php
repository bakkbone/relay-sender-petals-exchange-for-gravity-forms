...
define('PGF_MAP_FIELDS_TOOLTIP', sprintf(__('Link form fields to Petals API fields. See documentation %1$shere%2$s.', 'relay-sender-petals-exchange-for-gravity-forms'), '<a href="https://www.petals-exchange.com/relay/transmission/ufo.htm" target="_blank">', '</a>'));
